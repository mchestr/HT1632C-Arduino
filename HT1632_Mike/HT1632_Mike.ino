...
void demo_chars ()
{
  for(int i = 31; i > -54; i--)
  {
    ht1632_putChar(i, 8, 'R');
    ht1632_putChar(i+6, 8, 'e');
    ht1632_putChar(i+12, 8, 's');
    ht1632_putChar(i+18, 8, 'i');
    ht1632_putChar(i+24, 8, 's');
    ht1632_putChar(i+30, 8, 't');
    ht1632_putChar(i+36, 8, 'a');
    ht1632_putChar(i+42, 8, 'n');
    ht1632_putChar(i+48, 8, 'c');
    ht1632_putChar(i+54, 8, 'e');
    ht1632_bresLine(i,8,i,15,BLACK);
  }
...
{
  //demo_chars();
  //displayDecimal(thermister(analogRead(0)),0,0);
  double voltage = analogRead(0)*(5.0/1023.0);
